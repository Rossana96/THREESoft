...
@NamedQueries({
    ...
    , @NamedQuery(name = "Academico.findByCorreoAndPassword", query = "SELECT a.correoAca,a.password FROM Academico a WHERE a.correoAca = ?1 and a.password = ?2")})
public class Academico implements Serializable {
    ...
    public String toString() {
        return "com.threesoft.amoxcalitimer.model.Academico[ idAcademico=" + idAcademico + " ]";
    }
