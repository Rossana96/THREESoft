...
public class AdministradorJpaController implements Serializable {
    ...
    public Administrador findAdministrador(String correo) {
        EntityManager em = getEntityManager();
        Query q = em.createNamedQuery("Administrador.findByCorreoAdmin")
                .setParameter("correo_admin", correo);
    ...
    public boolean findAdministradorCorreoYPass(String correo, String contra) {
        EntityManager em = getEntityManager();
        Query q = em.createNamedQuery("Administrador.findByCorreoAndPassword")
